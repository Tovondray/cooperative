...
SECRET_KEY = 'django-insecure-%#j2tirw@@o!a+7opw2t76d#09#s)(3iy3a6v!&_)c)22s2q6i'
...
# Base de données PostgreSQL nommée "cooperative"
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'cooperative',
        'USER': 'postgres',          # adapte selon ton utilisateur
        'PASSWORD': '123mdp',        # adapte selon ton mot de passe
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
